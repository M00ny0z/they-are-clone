class Sniper {
    constructor(game, x, y) {
        ...
        this.attackSpeedInSec =  this.game.stats["Sniper"].attackSpeedInSec
        this.visualRadius = this.game.stats["Sniper"].visualRadius;
        this.maxSpeed = this.game.stats["Sniper"].maxSpeed; // pixels per second
        this.hitpoints = this.game.stats["Sniper"].health;
   ...
   update() {
    ...
    draw(ctx) {
        ...
        if (this.hitpoints < this.game.stats["Sniper"].health) {
            drawHealthbar(ctx, this.hitpoints, this.x, this.y, this.game,  this.game.stats["Sniper"].health);
        }
