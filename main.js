...
ASSET_MANAGER.downloadAll(function () {
	...
	// gameEngine.addEntity(new Soldier(gameEngine, 450, 150, [{x: 350, y: 150}]));
	// gameEngine.addEntity(new InfectedHarpy(gameEngine, 150, 150, [{x: 250, y: 150}]));

	// gameEngine.addEntity(new InfectedUnit(gameEngine, 450, 150, [{x: 449, y: 150}]));
	// let t = new InfectedHarpy(gameEngine, 450, 150, [{x: 449, y: 150}]);
