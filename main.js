...
ASSET_MANAGER.downloadAll(function () {
	...
	gameEngine.addEntity(new Soldier(gameEngine, 250, 250));	//target
	...
	gameEngine.addEntity(new Titan(gameEngine, 1000, 500, [{x : 600, y: 500}, {x : 400, y: 400}, {x : 200, y: 400}, {x : 0, y: 0}]));
	gameEngine.start();
});